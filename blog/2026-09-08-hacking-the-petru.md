---
layout: single
title: "Hacking the Petru: Patching a Sealed ESP32 with No Source, No Schematic, and No Data Port"
excerpt: "A desk gadget scrolls NOW PLAYING. I wanted TUNA STREET. No source, no schematic, no data USB — just a spare dev board as a probe, five strands of an Ethernet cable, and a 44-byte patch the bootloader accepts."
header:
...
<video src="https://github.com/user-attachments/assets/2d9c71da-db3f-41fc-98f0-7093c18e0f04" controls width="100%"></video>
...
![Ethernet strands wired into the header](https://github.com/user-attachments/assets/3b526285-5fbd-42fd-9baa-ba55418e02a6)

![Bridge and board on the bench](https://github.com/user-attachments/assets/c6e6c1d1-9647-49c4-adba-e7211b933945)

![Wiring close-up](https://github.com/user-attachments/assets/9b35a4c3-7684-4acb-a9c3-c8997a20ad2a)
