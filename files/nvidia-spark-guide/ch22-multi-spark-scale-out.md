# Chapter 22: Two, three, four Sparks: ConnectX-7, NCCL, 1M context
...
What a second box buys (1M-token context, tensor-parallel serving), the ring/switch topologies NVIDIA documents, and when it is worth it.
