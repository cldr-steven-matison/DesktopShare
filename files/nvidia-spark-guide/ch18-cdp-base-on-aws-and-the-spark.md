# Chapter 18: CDP Base on AWS + the DGX Spark
...
Community Edition / Base on EC2 as the target for Spark-hosted NiFi and Kafka, the inbound paths that actually work, and RAPIDS for Apache Spark on the Base side.
