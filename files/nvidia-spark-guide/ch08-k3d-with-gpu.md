# Chapter 8: k3d with GPU on GB10
...
The nvidia container runtime, the CUDA-enabled k3s node image k3d needs, the device-plugin version floor for unified memory, and the k3s-bare fallback — with a GPU pod proven on the cluster.
