...
mapfile -t paths < <(cat)
if [ "${#paths[@]}" -eq 0 ]; then
  exec python3 /home/tunas/DesktopShare/files/issue-226/kb/ingest.py
fi
...
exec python3 /home/tunas/DesktopShare/files/issue-226/kb/ingest.py "${paths[@]}"
