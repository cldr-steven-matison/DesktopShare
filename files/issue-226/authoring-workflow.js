...
const DOCS = [
  {
    ws: 'F', file: 'nvidia-dgx-spark-k3s-cso.md', issue: 238, target: '300-400',
  ...
  },
  {
    ...
    precedent: [
      ...
      `${REPO}/nvidia-dgx-spark-cso-demos.md (the on-box EFM + NiFi demo catalogue, rewritten 2026-09-08), ${REPO}/flink-agents-cso-plan.md and ${REPO}/files/cso-prod-1/flink-agents/ (the Flink Agents job that would run against both backends)`,
