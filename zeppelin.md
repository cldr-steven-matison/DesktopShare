...
If you upgraded (or are planning to upgrade) to **Cloudera Runtime 7.3.2** (or any 7.3.1+ release), you’ve already discovered that **Apache Zeppelin has been fully removed** from the Cloudera stack. It’s no longer shipped, installable through the normal Cloudera Manager wizard, or supported by Cloudera.
...
Full detailed guide lives here: [Reinstall Apache Zeppelin in 7.3.1](https://docs.cloudera.com/cdp-private-cloud-base/7.3.1/zeppelin/topics/installing_zeppelin_731.html).
...
Cloudera’s explicit advice remains the same as it was in 7.3.1: **back up everything before upgrading**, and plan your migration.
