...
| 5 | Java processor catalog | `minifi-playground-java-processors.md` | — | 🟡 | Yes (114, no ExecuteScript/Kafka) | [MINI-Gaming-G1 or FTF3XR2065 — either local Docker/minikube host] Verify Docker `minifi-java:latest` |
