...
- **NvidiaSpark-1** — the NVIDIA **DGX Spark** (GB10 Grace Blackwell, 128 GB unified, aarch64), landed 2026-08-26 as hostname `spark-dd06`; desk-class local-AI host + on-box k3d/CSO + EFM agent. Planning: `nvidia-dgx-spark-plan.md`. **Naming rule:** "DGX Spark" is the box, "Apache Spark" is the engine — never bare "Spark" in a Cloudera-integration sentence.
