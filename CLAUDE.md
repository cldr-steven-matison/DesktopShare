...
- **Touch a published asset and you sweep its plan doc, its status tracker, and its README in the same pass** — all three, before reporting the work done, not just the artifact you were editing. Canon: `agent/workflow.md` §"Touch an asset, sweep all three surfaces" (#295 rewrote 21 guide chapters and left `EdgeFlowManager/README.md` stale and out of band).
