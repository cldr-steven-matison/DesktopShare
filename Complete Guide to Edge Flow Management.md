...
| **18**<br>🔲<br>[#32](https://github.com/cldr-steven-matison/DesktopShare/issues/32) | **Sample gallery of MiNiFi flows**<br>src `minifi-sample-gallery.md` (stub)<br>blog — | No | FTF3XR2065 | Scaffold the gallery + seed with flows already built (#32); accumulate more as built |
