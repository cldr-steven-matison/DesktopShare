...
2026-08-03: neither cluster becomes a new chapter.** The
...
**Part IV — Site-to-Site** (Ch10–11)
The two local k8s transport legs (MiNiFi → NiFi). The three cloud CDP legs (NiFi→DataFlow,
NiFi→Data Hub, DataFlow→Data Hub) were **descoped 2026-08-03**. Reference: apache `SITE_TO_SITE.md`.
