...
| **14**<br>🔲 | **NiFi and AI Skill — EFM Portion**<br>src `skills/nifi-and-ai/` (skill)<br>blog — | — | FTF3XR2065 | New chapter added to tracker 2026-08-03 (human edit to `efm-guide-summary.md`). Scope: fold the EFM-relevant portion of the `nifi-and-ai` skill into a reader-facing guide chapter. Not yet scoped or drafted; no issue filed yet. Slotted into Part V (AI at the Edge) as the skill-grounding lead-in ahead of Ch15–17. Reuses the number freed when the cloud S2S Ch12–14 legs were descoped 2026-08-03. |
