...
| **21** 🟡 | Yes | Metrics & Observability | Layer 2 (Java) closed 2026-08-14: Route 3 flow-level exporter documented + live ([#166](https://github.com/cldr-steven-matison/DesktopShare/issues/166) ✓). Remaining: Layer 3 (XIAO/MicroFi panel) + StarlinkAI-over-Tailscale ([#140](https://github.com/cldr-steven-matison/DesktopShare/issues/140)). |
