...
> **Status (2026-09-08 — NvidiaSpark-1): #272 and #271 CLOSED on Steven's review.** #272's closure criterion (the demo's posted captions come from the Spark brain) was met by the B5 promote of 2026-09-01; #271 K1–K3 and K5 are live, and the unstarted K4 accretion is tracked under #304 with the human-input ask. The S2S seam upgrade is not filed — the `:32111` HTTP door stays the seam. Same day, the `KB →` link came off the main-screen Watch List pills (cso-operator-app `bc8b29b`, redeploy handed to WindowsDesktop on #302); it stays on the roster-tab rows only.
>
