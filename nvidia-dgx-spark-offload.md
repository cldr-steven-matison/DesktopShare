...
- ⏳ L4: gate met on `doc-check.py` quality first, then the windowed ratio, recorded as a dated row with the rung named in the issue comment that lands it.
